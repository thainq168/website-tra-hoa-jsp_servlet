...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
      ...
      .carousel-item:nth-child(1) {
        background-image: url('https://cdn-www.vinid.net/2020/10/d0828a00-c%C3%A1ch-l%C3%A0m-tr%C3%A0-hoa-h%E1%BB%93ng-1024x577.jpg');
      ...
      .carousel-item:nth-child(2) {
        background-image: url('https://trathaoduocarlo.vn/wp-content/uploads/2020/11/Tra-hoa-cuc-Khanh-Phong-scaled.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
      }
      ...
      .carousel-item:nth-child(3) {
        background-image: url('http://mangrung.vn/wp-content/uploads/2020/06/tra-hoa-dau-biec.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
      }
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    ...
    <div class="card-body">
      <h5 class="card-title" style="text-align:center">SẢN PHẨM CHẤT LƯỢNG</h5>
      <p class="card-text" style="text-align:center">Đạt chuẩn kiểm định</p>
    </div>
  </div>
  <div class="card" style="border-style: none;">
                        ...
                        <div id="content" class="row">
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">Camellia</h2>
                                        <p >Camellia là cửa hàng chuyên cung cấp các loại trà hoa với giá rẻ và chất lượng vượt ngoài sự mong đợi.
                                        Chúng tôi cam kết mang đến cho bạn những sự lựa chọn tuyệt vời để ngăn cản sự lão hóa theo thời gian,
                                        mang lại giấc ngủ ngon, làn da căng bóng đầy sức sống...</p>
										<p>Các dòng sản phẩm đa dạng có đến hàng chục loại sản phẩm trong và ngoài nước với mẫu mã và chủng loại khác nhau, cho bạn tha hồ chọn lựa.
										Giá cả phải chăng, chất lượng tuyệt đỉnh sẽ làm bạn cảm thấy hài lòng!</p>                  
                                    </div>  
                            </div>
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <img class="card-img-top" src="https://salt.tikicdn.com/ts/tmp/82/b2/79/ae46ebd8ffbc9de5c1fdcad1860570b5.jpg" alt="Card image cap">        
                            </div>
                    </div>
                </div>
            </div>
